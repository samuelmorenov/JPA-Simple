...
import uo.alb.util.linker.Multiplicity;
import uo.alb.util.linker.SideHandler;
import uo.alb.util.assertion.Argument;
import uo.alb.util.linker.handler.ManySideHandler;
import uo.alb.util.linker.handler.NonNavigableSideHandler;
import uo.alb.util.linker.handler.OneSideHandler;
